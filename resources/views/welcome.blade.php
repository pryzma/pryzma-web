...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    <head>
        ...
        <title>Pryzma Development</title>
    ...
    <body class="text-center">
        ...
        <div class="cover-container d-flex w-100 h-100 p-3 mx-auto flex-column">
            <header class="masthead mb-auto">
                <div class="inner">
                <h3 class="masthead-brand">Pryzma</h3>
            ...
            <main role="main" class="inner cover">
                <h1 class="cover-heading">Some Catchy Header</h1>
                <p class="lead">This is a text to fill up this space in the meantime. Will be replaced with something really, really meaningfull</p>
                <p class="lead">
                <a href="#" class="btn btn-lg btn-secondary">Some useful button</a>
                </p>
            </main>
